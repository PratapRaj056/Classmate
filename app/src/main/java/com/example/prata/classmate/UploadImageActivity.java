...
import com.example.prata.classmate.sugarrecord.PermissionUtils;
    ...
    public void onRequestPermissionsResult(
        ...
        switch (requestCode) {
            case CAMERA_IMAGE_REQUEST:
                if (PermissionUtils.permissionGranted(requestCode, CAMERA_IMAGE_REQUEST, grantResults)) {
                    startCamera();
                }
                break;
            case GALLERY_IMAGE_REQUEST:
                if (PermissionUtils.permissionGranted(requestCode, GALLERY_IMAGE_REQUEST, grantResults)) {
                    startGalleryChooser();
                }
                break;
        }
    ...
    public void uploadImage(Uri uri) {
        if (uri != null) {
            try {
                ...
                Toast.makeText(this, "PICK ERROR", Toast.LENGTH_LONG).show();
            }
        } else {
